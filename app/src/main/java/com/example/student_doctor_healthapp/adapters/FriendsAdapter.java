package com.example.student_doctor_healthapp.adapters;
...
import com.example.student_doctor_healthapp.R;
import com.example.student_doctor_healthapp.User;

import java.util.ArrayList;

public class FriendsAdapter extends RecyclerView.Adapter<FriendsAdapter.FriendsViewHolder> {

    private final ArrayList<com.example.student_doctor_healthapp.User> users;
